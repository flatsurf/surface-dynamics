...
class AbelianStratum(Stratum):
    ...
    def cylinder_diagrams_number(self, ncyls=None, force_computation=False):
        ...
        used. It might be slower for large strata::
            ...
            ....:     print("%d %d" %(H31.cylinder_diagrams_number(d, False),
            ....:                     H31.cylinder_diagrams_number(d, True)))
            2 2
            12 12
            16 16
            4 4
            ...
            ....:     print("%d %d" % (H211.cylinder_diagrams_number(d, False),
            ....:               H211.cylinder_diagrams_number(d, True)))
            5 5
            29 29
            53 53
            27 27
...
class AbelianStratumComponent(StratumComponent):
    ...
    def single_cylinder_origami(self):
    	...
    	t1 = [1]
    	for i in range(len(perm[1])-2):
    		ind = perm[1].index(t1[i])
    		t1.append(ind+1)
    	t1 = tuple(t1)
    	return Origami(t0,t1)
...
class HypAbelianStratumComponent(ASC):
    ...
    def single_cylinder_representative(self):
    	...
    	if nb_real_zeros==1 and add_fk_zeros<0:
    		...
    		bot_row = bot_row + [2*genus-1+i for i in range(add_fk_zeros+1)]
