...
class RibbonGraph(SageObject):
    ...
    def monodromy_group(self):
        ...
        EXAMPLES::
            ...
            sage: G1
            Subgroup generated by [(1,3,4,5), (0,1)(2,3)(4,5), (0,5,3,2,1)] of
            ...
            sage: G2
            Subgroup generated by [(1,3,4)(5,6,7), (0,1)(2,3)(4,5)(6,7), (0,4,7,5,3,2,1)] of
            ...
            Subgroup generated by [(), (1,5)] of
            (Symmetric group of order 2! as a permutation group)
        """
        S = self._symmetric_group()
        v = S([i for i in self._vertices if i != -1])
        e = S([i for i in self._edges if i != -1])
        f = S([i for i in self._faces if i != -1])
        assert (v*e*f).is_one()
    ...
    def automorphism_group(self, fix_vertices=False, fix_edges=False, fix_faces=False):
        ...
        Examples in genus 1::
            ...
            sage: A
            Subgroup generated by [(1,2)(3,4)(5,6), (1,3,5,2,4,6), (1,5,4)(2,6,3)] of
            (Symmetric group of order 6! as a permutation group)
            sage: A.cardinality()
            6
